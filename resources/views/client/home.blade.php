...
<head>
    ...
    <title><?php echo !empty($title) ? 'Title-' . $title : 'Laravel online shop'; ?></title>
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                        <picture>
                            ...
                            <img src="{{ asset('front-assets/images/carousel-2.jpg') }}" />
                        </picture>
                        ...
                        @foreach (getCategories() as $category)
                            <div class="col-lg-3">
                                <div class="cat-card">
                                    <div class="left" >
                                        @if ($category->image != '')
                                            <img src="{{ asset('upload-img/category/thumb/' . $category->image) }}" style="height: 100%"
                                                alt="hh" class="img-fluid">
                                        @endif
                                    </div>
                                    <div class="right">
                                        <div class="cat-data">
