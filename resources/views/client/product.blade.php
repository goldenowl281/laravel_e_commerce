	...
	<section class="section-7 pt-3 mb-3">
		<div class="container">
				...
				<div class="col-md-5">
					<div id="product-carousel" class="carousel slide"
						...
						<div class="carousel-inner bg-light">
							@php
									$product_imgs = $product->product_images;
							@endphp
							@if ($product_imgs )
								@foreach ($product_imgs as $key=> $product_img)
									<div class="carousel-item {{ ($key == 0)? 'active': '' }}">
										<img class="w-100 h-100"
												src="{{ asset('upload-img/product/full-img/'.$product_img->image) }}" alt="Image">
									</div>
								@endforeach
							@endif
						</div>
            ...
            @php
						...
						@endphp
						@if ($compare_price>0 )
							<h2 class="price text-secondary"><del>${{$compare_price}}</del></h2>
						@endif
			...
			<div class="container">
				...
				<div class="col-md-12">
					<div id="related-products" class="carousel">
						...
						@php
							$product_img = $related_product->product_images->first();
						@endphp
							<div class="card product-card">
								...
								<div class="card-body text-center mt-3">
									...
									<div class="price mt-2">
										<span class="h5">
											<strong>${{$related_product->price}}</strong>
										</span>
										@if ($related_product->compare_price > 0)
											<span class="h6 text-underline">
												<del> {{$related_product->compare_price}}</del>
											</span>
										@endif
									</div>
								</div>
