                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            value="{{ $product->title }}" id="title" class="form-control"
                                                placeholder="Title">
                                            <p class="error"></p>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            value="{{ $product->title }}" id="slug" class="form-control"
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description"
                                             id="description" cols="30" rows="10" class="summernote"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            value="{{ $product->price }}" id="price" class="form-control"
                                                placeholder="Price">
                                            <p class="error"></p>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            value="{{ $product->barcode }}" id="barcode" class="form-control"
                                                placeholder="Barcode">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <select name="is_featured" id="is_featured" class="form-control">
                                        <option value="No"
                                        {{ ($product->is_featured == "No")?'selected':'' }}
                                        >
                                            No
                                        </option>
                                        <option value="Yes"
                                        {{ ($product->is_featured == "Yes")?'selected':'' }}
                                        >
                                            Yes
                                        </option>
                                    </select>
